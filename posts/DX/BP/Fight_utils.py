...
def predict_on_video(video_file_path, output_file_path, model, SEQUENCE_LENGTH,skip=2,showInfo=False):
    ...
    while video_reader.isOpened():
        ...
        if predicted_class_name=="fight":
          cv2.putText(frame, predicted_class_name, (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 0, 255), 3)
        else:
          cv2.putText(frame, predicted_class_name, (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 255, 0), 2)
        counter+=1
